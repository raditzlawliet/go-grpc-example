...
type GreeterClient interface {
	...
	SayHelloAgain(ctx context.Context, in *SayHelloRequest, opts ...grpc.CallOption) (*SayHelloResponse, error)
}
...
func (c *greeterClient) SayHelloAgain(ctx context.Context, in *SayHelloRequest, opts ...grpc.CallOption) (*SayHelloResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SayHelloResponse)
...
type GreeterServer interface {
	...
	SayHelloAgain(context.Context, *SayHelloRequest) (*SayHelloResponse, error)
...
func (UnimplementedGreeterServer) SayHelloAgain(context.Context, *SayHelloRequest) (*SayHelloResponse, error) {
...
func _Greeter_SayHelloAgain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).SayHelloAgain(ctx, req.(*SayHelloRequest))
	}
	return interceptor(ctx, in, info, handler)
}
